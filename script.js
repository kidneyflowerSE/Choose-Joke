...
tl.add('offSelected')
    ...
    .to('#offDot', { attr: { r: 14 }, duration: 0.6, ease: 'elastic(0.6, 0.4)' }, 'offSelected')
    .to('#offRing', { stroke: uiBlue }, 'offSelected')
    .to('#offText', { fill: uiBlue }, 'offSelected');

tl.add('handIn', '+=1')
    .from(['#allRobotHands', '#robotThumb'], { x: 60, y: -180, duration: 0.4, ease: 'back(0.3)' }, 'handIn')
    ...
    .add('handAcross')
    .to(['#allRobotHands', '#robotThumb'], { x: 120, y: 0, ease: 'back.inOut(0.53)' }, 'handAcross')
    .to(['#allRobotHands', '#robotThumb', '#offDot'], { y: '-=50', duration: 0.15, ease: 'sine.in' }, 'handAcross')
    .to(['#allRobotHands', '#robotThumb', '#offDot'], { y: '+=50', duration: 0.15, ease: 'sine' }, 'handAcross+=0.15')
    ...
    .to(['#allRobotHands', '#robotThumb'], { y: '-=20', duration: 0.4, ease: 'sine.inOut' }, 'handAcross+=0.3');


tl.add('hornHands', '+=0.35')
    .to(['#allRobotHands', '#robotThumb'], { y: '+=20', duration: 0.166 }, 'hornHands')
...
tl.add('handOut', '+=0')
    .to(['#allRobotHands', '#robotThumb'], { x: 160, y: -200, ease: 'sine.in' }, 'handOut')
